...
class LaporanpegawaiController extends AdminBaseController
{
...
date_default_timezone_set('Asia/Makassar'); 
    ...
    public function index()
    {
        ...
        return View::make('admin.laporanpegawai.attendance-sheet', $this->data);
    }
  ...
  public function create()
    {
        ...
        return View::make('admin.laporanpegawai.create', $this->data);
    ...
    public function show($id)
    {
        ...
        return View::make('admin.laporanpegawai.show', $this->data);
    }
...
->get(); 
        ...
        $view = View::make('admin.laporanpegawai.load', $this->data)->render();
