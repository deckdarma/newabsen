...
class SiangshiftsController extends AdminBaseController
{
    public function __construct()
    {
        ...
        $this->pageTitle = trans("pages.siangshifts.indexTitle");
date_default_timezone_set('Asia/Makassar'); 
    ...
    public function index()
    {
        ...
        return View::make('admin.siangshifts.siangshift-sheet', $this->data);
    }
    ...
    public function shiftsiang()
    {
        ...
        return \Redirect::route('admin.siangshifts.edit', $date);
    }
  ...
  date_default_timezone_set('Asia/Makassar');
	  ...
	  $tgl=date("Y-m-d");
        ...
        return View::make('admin.siangshifts.create', $this->data);
    ...
    public function edit($date_str)
    {
	 ...
	 $this->pageTitle = "Jadwal Shift Pagi";
        ...
        return \View::make('admin.siangshifts.edit', $this->data);
    }
    ...
    public function update($date_str)
    {
        ...
        // Get all employee ids for this company
             ...
             $allEmployeeIDs = Employee::where("employees.shift", "1")->where("employees.status", "active")
		->pluck("id");
                ...
                if (in_array($employeeID, $employeeIDs)) {
                    ...
                    if ($datashift->application_status != 'approved' || ($datashift->application_status == 'approved' && $data[$employeeID]["status"] == 'true')) {
                        ...
                        if ($data[$employeeID]["status"] == "true") {
                            ...
                            $datashift->leaveType = "1427";
                            $datashift->nama_shift = "Shift Sore";
    ...
    public function destroy($id)
    {
        ...
        return Redirect::route('admin.siangshifts.index');
    }
    ...
    public function ajax_siangshift(Request $request)
    {
        if ($request->has('date')) {
        ...
        return DataTables::of($result)
            ...
            ->editColumn('status', function ($row) use ($leaveTypes) {
                return \View::make("admin.siangshifts.col2", ["row" => $row, "leaveTypes" => $leaveTypes])->render();
            })
            ->editColumn('date', function ($row) {

                $datashift_mark = \View::make("admin.siangshifts.col3", ["row" => $row])->render();
