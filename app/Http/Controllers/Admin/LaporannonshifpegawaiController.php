...
class  LaporannonshifpegawaiController extends AdminBaseController
{
...
date_default_timezone_set('Asia/Makassar'); 
    ...
    public function index()
    {
        ...
        return View::make('admin.laporannonshifpegawai.attendance-sheet', $this->data);
    }
  ...
  public function create()
    {
        ...
        return View::make('admin.laporannonshifpegawai.create', $this->data);
    ...
    public function show($id)
    {
        ...
        return View::make('admin.laporannonshifpegawai.show', $this->data);
    }
...
->get(); 
        ...
        $view = View::make('admin.laporannonshifpegawai.load', $this->data)->render();
