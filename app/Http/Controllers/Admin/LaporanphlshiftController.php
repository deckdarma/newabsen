...
class LaporanphlshiftController extends AdminBaseController
{
...
date_default_timezone_set('Asia/Makassar'); 
    ...
    public function index()
    {
       $this->LaporanhiftOpenpeg = 'active';
	     $this->pageTitle = "Laporan Pegawai Shift (PHL)";
        ...
        return View::make('admin.laporanphlshift.attendance-sheet', $this->data);
    }
  ...
  public function create()
    {
        ...
        return View::make('admin.laporanphlshift.create', $this->data);
    ...
    public function show($id)
    {
        ...
        return View::make('admin.laporanphlshift.show', $this->data);
    }
...
->get(); 
        ...
        $view = View::make('admin.laporanphlshift.load', $this->data)->render();
