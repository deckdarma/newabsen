...
class KehadiranadminController extends AdminBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->attendancesOpen = 'active';
        $this->absMenuActive = 'active';
        $this->pageTitle = trans("Tambah Kehadiran (ASN)");
date_default_timezone_set('Asia/Makassar'); 
    ...
    public function index()
    {
        ...
        return \Redirect::route('admin.kehadiranadmin.edit', $date);
    }
    ...
    public function edit($date_str)
    {
        ...
        return \View::make('admin.kehadiranadmin.edit', $this->data);
    }
    ...
    public function destroy($id)
    {
        ...
        return Redirect::route('admin.kehadiranadmin.index');
    }
    ...
    public function updateAttendanceRow(UpdateRequest $request)
    {
        ...
        if ($attendance->application_status != 'approved' || ($attendance->application_status == 'approved' && $input['status'] == 'present')) {
            ...
            return [
                ...
                'divHTML' => \View::make("admin.kehadiranadmin.col3", ["row" => $attendance])->render()
            ];
    ...
    public function ajax_attendance(Request $request)
    {
        ...
        return DataTables::of($result)
            ...
            ->editColumn('date', function ($row) {
                ...
                $attendance_mark = \View::make("admin.kehadiranadmin.col3", ["row" => $row])->render();
            ...
            ->editColumn('clock_in', function ($row) {
                ...
                return \View::make("admin.kehadiranadmin.col4", [
