...
class LaporanpegawaishiftController extends AdminBaseController
{
...
date_default_timezone_set('Asia/Makassar'); 
    ...
    public function index()
    {
       $this->LaporanhiftOpenpeg = 'active';
	     $this->pageTitle = "Laporan Pegawai Shift (ASN)";
        ...
        return View::make('admin.laporanpegawaishift.attendance-sheet', $this->data);
    }
  ...
  public function create()
    {
        ...
        return View::make('admin.laporanpegawaishift.create', $this->data);
    ...
    public function show($id)
    {
        ...
        return View::make('admin.laporanpegawaishift.show', $this->data);
    }
...
$this->datashiflihat = Datashift::where('datashift.employee_id', '=', $request->employee_id)

->select("datashift.date as dateshif", "datashift.leaveType as iddateshif", "datashift.nama_shift as nama_shift")
->where(DB::raw('MONTH(datashift.date)'), '=', $request->month)
->where(DB::raw('YEAR(datashift.date)'), '=', $request->year)
-> where('datashift.status', '=', 'hadir')
->get();

$this->datashiflihatcount = Datashift::where('datashift.employee_id', '=', $request->employee_id)
...
$this->attendanceas22 = Attendance::where('attendance.employee_id', '=', $request->employee_id)


->leftJoin('datashift', 'attendance.date', '=', 'datashift.date')
->where('datashift.status', '=', 'hadir')
->where('datashift.employee_id', '=', $request->employee_id)
...
$this->attendanceas = Attendance::where('attendance.employee_id', '=', $request->employee_id)

->leftJoin('datashift', 'attendance.date', '=', 'datashift.date')
->leftJoin('jadwalshifts', 'attendance.normal', '=', 'jadwalshifts.normal' )
...
"datashift.date as dateshif", "datashift.leaveType as iddateshif", "datashift.nama_shift as nama_shift",
...
"attendance.apel_sore as apel_sore",
"attendance.apel_sore as apel_sore",
"jadwalshifts.jam_masuk_jumat as jam_masuk_normal_jumat",
"jadwalshifts.ONTIME_masuk_jumat as ONTIME_masuk_normal_jumat",
"jadwalshifts.SKOR1_masuk_jumat as SKOR1_masuk_normal_jumat",
"jadwalshifts.SKOR2_masuk_jumat as SKOR2_masuk_normal_jumat",
"jadwalshifts.SKOR3_masuk_jumat as SKOR3_masuk_normal_jumat",
...
->get(); 
        ...
        $view = View::make('admin.laporanpegawaishift.load', $this->data)->render();
