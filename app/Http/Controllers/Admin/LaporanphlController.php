...
class LaporanphlController extends AdminBaseController
{
...
$this->pageTitle = "Laporan Pegawai (PHL)";
        ...
        return View::make('admin.laporanphl.attendance-sheet', $this->data);
    }
    ...
    public function create()
    {
        ...
        return \Redirect::route('admin.laporanphl.edit', $date);
    }
   ...
   public function edit($date_str)
    {
		   $this->pageTitle = "Laporan Harian PHL";
        ...
        return \View::make('admin.laporanphl.edit',  $this->data);
    }
 ...
 $result = Employee::manager(admin()->id)
        ...
        return DataTables::of($result)
            ...
            ->editColumn('status', function ($row) use ($leaveTypes) {
                return \View::make("admin.laporanphl.col2", ["row" => $row, "leaveTypes" => $leaveTypes])->render();
            })
            ->editColumn('date', function ($row) {

                $attendance_mark = \View::make("admin.laporanphl.col3", ["row" => $row])->render();
            ...
            ->editColumn('clock_in', function ($row) {
                ...
                return \View::make("admin.laporanphl.col4", [
...
->get(); 
        ...
        $view = View::make('admin.laporanphl.load', $this->data)->render();
