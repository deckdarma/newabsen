...
class DataApelController extends AdminBaseController
{
    public function __construct()
    {
      ...
      parent::__construct();
        ...
        $this->pageTitle = trans("Data Apel");
...
date_default_timezone_set('Asia/Makassar'); 
    ...
    {
        $this->viewDataApelActive = 'active';

        /*$this->date = Carbon::now()->format('Y-m-d');

        return View::make('admin.dataapel.index', $this->data);*/
        ...
        return View::make('admin.dataapel.attendance-sheet', $this->data);
    }
...
as a'), "a.employee_id", "=", "employees.id")
        ...
        return DataTables::of($result)
            ->addColumn('edit', function ($row) {
                ...
                $string = ' <a class="btn purple btn-sm" href="' . route('admin.dataapel.show', $row->id) . '">
    ...
    public function create()
    {
        ...
        return \Redirect::route('admin.dataapel.edit', $date);
    }
    ...
    public function show($id)
    {
        ...
        return View::make('admin.dataapel.show', $this->data);
    }
    ...
    public function edit($date_str)
    {
        ...
        return \View::make('admin.dataapel.edit', $this->data);
    }
    ...
    public function report()
    {
        ...
        $holidaycount = count(DB::select(DB::raw("SELECT * FROM holidays WHERE MONTH(date)=" . $month . "  AND YEAR(date)=" . $year . "")));
    ...
    public function destroy($id)
    {
        ...
        return Redirect::route('admin.dataapel.index');
    }
    ...
    public function updateAttendanceRow(UpdateRequest $request)
    {
        ...
        if ($attendance->application_status != 'approved' || ($attendance->application_status == 'approved' && $input['status'] == 'present')) {
            if ($input['status'] == 'present') {
                ...
                $attendance->apel_pagi = request()->get('apel_pagi');
                $attendance->apel_sore = request()->get('apel_sore');
            ...
            return [
                ...
                'divHTML' => \View::make("admin.dataapel.col2", ["row" => $attendance])->render()
            ];
  ...
  $result = Employee::manager(admin()->id)
        ...
        return DataTables::of($result)
            ...
            ->editColumn('status', function ($row) use ($leaveTypes) {
                ...
                if ($row->clock_out != null) {
                    ...
                    $input_value_clock_out = Carbon::createFromFormat('H:i:s', admin()->company->office_end_time, 'Asia/Makassar')->timezone($this->timezones[admin()->company->timezone])->format('g:i A');
				       ...
				       return \View::make("admin.dataapel.col2", [
            ...
            ->removeColumn('apel_pagi')
            ->removeColumn('apel_sore')
            ->removeColumn('id')
    ...
    public function filterAttendance(Request $request)
    {
        ...
        $view = View::make('admin.dataapel.load', $this->data)->render();
