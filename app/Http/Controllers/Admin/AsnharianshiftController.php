...
class AsnharianshiftController extends AdminBaseController
{
...
date_default_timezone_set('Asia/Makassar'); 
     ...
     public function index()
    {
        ...
        $this->LaporanbulhiftOpenpeg = 'active';
        ...
        return View::make('admin.asnharianshift.attendance-sheet', $this->data);
    }
    ...
    public function asndata()
    {
        ...
        return \Redirect::route('admin.asnharianshift.edit', $date);
    }
   ...
   public function edit($date_str)
    {
		...
		$this->phldatashifMenuActive = 'active';
		   $this->pageTitle = "Laporan Harian ASN Shift";
        ...
        return \View::make('admin.asnharianshift.edit',  $this->data);
    }
...
"attendance.status as status", 
        ...
        return DataTables::of($result)
            ...
            ->editColumn('status', function ($row) use ($leaveTypes) {
                return \View::make("admin.asnharianshift.col2", ["row" => $row, "leaveTypes" => $leaveTypes])->render();
            })
            ->editColumn('date', function ($row) {

                $attendance_mark = \View::make("admin.asnharianshift.col3", ["row" => $row])->render();
            ...
            ->editColumn('clock_in', function ($row) {
                ...
                return \View::make("admin.asnharianshift.col4", [
...
$this->employeeAttendence = $attendances;
        ...
        $view = View::make('admin.asnharianshift.load', $this->data)->render();
