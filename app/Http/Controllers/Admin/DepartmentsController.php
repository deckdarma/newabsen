...
class DepartmentsController extends AdminBaseController
{
    ...
    $cariid = Department::findOrFail($id);
		
		
	
    Employee::join('designation', 'designation.id', '=', 'employees.designation')
		->where('designation.department_id', '=', $cariid->id)
		->update(['employees.designation' => NULL]);	
