...
class LeavetypesController extends AdminBaseController
{
    ...
    public function __construct()
    {
        ...
        $this->pageTitle = trans('Jenis Keterangan');
    ...
    {
        $result = Leavetype::select('id', 'leaveType', 'num_of_leave', 'potongan', 'singkat', 'potongan_shift');
  ...
  <a href="javascript:;" onclick="del(' . $row->id . ',\'' . $row->leaveType . '\')" class="btn red btn-sm margin-bottom-10">
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::success('Keterangan Berhasil di tambah');
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::success('Berhsil di Update');
    }
    ...
    public function destroy(DeleteRequest $request, $id)
    {
        ...
        return Reply::success('Berhsil di Hapus');
