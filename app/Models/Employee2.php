...
class Employee2 extends BaseModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
   ...
   protected $table = "employees";
    ...
    {
        $birthdays = Employee2::where('company_id', $company_id)->select('full_name', 'date_of_birth', 'profile_image')
    ...
    public function leaveLeft()
    {
        ...
        $leaveLeft = array_sum(Attendance::absentEmployee2(employee()->id)) . '/' . $total_leave;
