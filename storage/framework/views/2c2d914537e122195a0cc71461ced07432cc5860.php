<div class="modal-content">
			 ...
			 <input style="background-color: #fcf0f0;border: 1px solid #c19696;" class="form-control"  id="employee_id" name="employee_id" type="hidden" value="<?php echo e($leavetype->employee_id); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
										      ...
										      <input class="form-control"   value="<?php echo e($leavetype->start_date); ?>" type="text"  name="start_date"  id="start_date" readonly>
			  ...
			  <?php $__currentLoopData = $leavetypes_shift; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idku): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php if($idku->waktumundur != "1" ): ?> 
    ...
    </script><?php /**PATH C:\xampp\htdocs\newabsen\resources\views/admin/newleave/edit.blade.php ENDPATH**/ ?>