...
<?php if($status !=  "1"): ?>	
	...
	<div class="label  label-<?php echo e($status); ?>">Masuk: <i class="fa fa-clock-o"></i> <?php echo e($row->clock_in); ?></div>
...
<?php if($row->pulangkantor != "00:00:00"): ?>
	...
	<div class="label  label-success" style="background-color: #1d319f;margin-bottom:3px;    display: block;">Pulang: <i class="fa fa-clock-o"></i> <?php echo e($row->clock_out); ?></div>
...
<?php else: ?>
-
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newabsen\resources\views/admin/attendances/col4_normal_jumat.blade.php ENDPATH**/ ?>