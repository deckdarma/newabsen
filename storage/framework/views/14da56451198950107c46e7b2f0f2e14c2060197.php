...
Laporan Harian ASN
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Laporan Harian ASN</span>
            </li>
        </ul>
                ...
                <div class="portlet-body form">
                    ...
                    <?php else: ?>
                        <div class="table-toolbar margin-top-15">
                            <div class="row">
                                <div class="col-md-4">
                                    <?php echo Form::open(['route'=>["admin.attendances.create"], 'method' => 'GET', 'class' => "form-inline", 'id' => "new_date"]); ?>
...
?>
		 ...
		 <a href="javascript:printDiv('id-elemen-yang-ingin-di-print');" class="btn green"> <i class="fa fa-print"></i>  Print <span
							...
							<div class="yeprint">
							<div style="text-align: center;font-weight: bold;font-size: 25px;">	LAPORAN HARIAN (ASN)        </div>
    ...
    <script>
        ...
        function loadDataTable() {
            table = $('#attendanceTable').dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "<?php echo e(URL::route("admin.attendance.ajax_attendance")); ?>",
                    "data": function (d) {
...
//			 $('#halfDayLabel').show(100);
        ...
        $('#date_change').datepickerabsen({
            ...
            var url = "<?php echo e(route("admin.attendances.edit", "#id")); ?>";
...
$('.datePicker').datepickerabsen({ beforeShowDay: unavailable });
        function ajaxUpdateAttendance() {
            ...
            var url = "<?php echo e(route("admin.attendances.update", "#id")); ?>";
            url = url.replace("#id", date);
