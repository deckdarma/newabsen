                ...
                <div class="portlet-body">
                        ...
                        <ul class="feeds">
                            ...
                            <?php $__currentLoopData = $company_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    ...
                                    <div class="col2">
                                        <div class="date" style="font-size:11px;"><?php echo e($company_data->last_in_words); ?></div>
                                    </div>
                                </li>
                    ...
                    <div class="scroller-footer">
                        <div class="btn-arrow-link pull-right">
                            <a onclick="loadView('<?php echo e(route('admin.companies.index')); ?>')">Lihat Semua OPD</a>
