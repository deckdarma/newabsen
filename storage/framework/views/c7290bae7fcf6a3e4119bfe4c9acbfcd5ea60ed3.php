...
<?php $__env->startSection('mainarea'); ?>
    ...
    <div class="page-head">
        <div class="page-title"><h1>
                <?php if($loggedAdmin->type=='superadmin'): ?>
                    <?php echo e($company->company_name); ?> <?php echo app('translator')->get("core.settings"); ?>
                <?php else: ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="#"><?php echo app('translator')->get("core.settings"); ?></a>
                <i class="fa fa-circle"></i>
            </li>

            <li>
                <span class="active"><?php echo app('translator')->get("core.generalSettings"); ?></span>
            </li>
        </ul>
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2">Logo OPD</label>
                            <div class="col-md-6">
                                ...
                                <div class="clearfix margin-top-10">
                                                        ...
                                                        Catatan!</span> Gambar Harus 40px Tinggi

                                </div>
   <div style="
    margin-top: 10px;
    font-size: 12px;color: #ff0000;
">Dengan Mengupload Logo Anda, tidak akan merubah logo OPD lain   </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-2 control-label">Nama OPD: <span class="required">
                                        * </span>
                            </label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Alamat Lengkap:
                            </label>
                            <div class="col-md-6">
                                ...
                                <input type="hidden" class="form-control" name="billing_address" value="Absensi">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">No HP:
                            </label>
                            <div class="col-md-6">
	    ...
	    <input type="hidden" class="form-control" name="name" value="Absensi">
                        <div class="form-group" style="display:none">
                            <label class="control-label col-md-2"><?php echo app('translator')->get("core.currency"); ?></label>
                            <div class="col-md-6">
                                <select class="select2me form-control" data-show-subtext="true" name="currency">
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($country->currency_symbol ?? $country->currency_code); ?>:<?php echo e($country->currency_code); ?>"
                                                <?php if($company->currency==$country->currency_code): ?> selected <?php endif; ?>><?php echo e($country->currency_code); ?> ( <?php echo e($country->currency_symbol ?? $country->currency_code); ?> )</option>
                        ...
                        <div class="form-group" id="abc" style="display:none">
                            <label class="col-md-2 control-label"><?php echo app('translator')->get("core.language"); ?>: </label>
                            <div class="col-md-6">

                                <select class="select2me form-control" name="locale" id="select_lang">
                                    <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lang->locale); ?>"
                                                <?php if($lang->locale == $company->locale): ?> selected="selected" <?php endif; ?>><?php echo e($lang->language); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group" id="timezone_container">
                            <input type="hidden" name="timezoneIndex" id="timezoneIndex"
                                   value="<?php echo e($company->timezone_index); ?>">
                            <label class="col-md-2 control-label"><?php echo app('translator')->get("core.timezone"); ?>: </label>
                            <div class="col-md-6">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-9">
                                <button type="button" onclick="updateSetting(<?php echo e($company->id); ?>)" data-loading-text="<?php echo e(trans('core.btnUpdating')); ?>..."
...
<?php $__env->startSection('footerjs'); ?>
    ...
    <script>
        ...
        function updateSetting(id) {
            var url = "<?php echo e(route('admin.general_setting.update')); ?>";
            $.easyAjax({
                type: 'POST',
                url: url,
                container: '.ajax_form',
