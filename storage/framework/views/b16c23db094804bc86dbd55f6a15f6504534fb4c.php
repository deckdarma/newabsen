...
<head>
	...
	<!-- Bootstrap CSS -->
	 <?php echo HTML::style("login/css/bootstrap.min.css"); ?>



	<?php echo HTML::style("login/css/fontawesome-all.min.css"); ?>


	<?php echo HTML::style("login/font/flaticon.css"); ?>

	<!-- Google Web Fonts -->
	<?php echo HTML::style("login/style.css"); ?>
				...
				<div class="col-md-6 col-12 fxt-bg-wrap" style="background: #c8d8e7;" >
					<div class="fxt-bg-img">
						<div class="fxt-header">
							...
							<img src="<?php echo e($setting->logo_image_url); ?>" alt="Logo">
							</div>
 ...
 yang juga dapat dijadikan dasar pemberian insentif kepada seluruh pegawai Pemerintah Kabupaten Banggai. Ini merupakan sistem tertutup yang memerlukan login untuk masuk, melihat data, dan melakukan aktifitas.</p>
        ...
        LIHAT ABSENSI ANDA
				...
				<div class="col-md-6 col-12 fxt-bg-color">
                   ...
                   placeholder="<?php echo e(trans('core.email')); ?>" name="email"/>
								</div>
								<div class="form-group">
									<label for="password" class="input-label">Password</label>
     <input class="form-control" type="password" autocomplete="off"
                   placeholder="<?php echo e(trans('core.password')); ?>" id="password" name="password"/>
    ...
    <?php echo Form::open(['url' => '', 'method' => 'post', 'class'=>'forget-form']); ?>
...
<?php echo HTML::script("login/js/jquery-3.5.0.min.js"); ?>

<?php echo HTML::script("login/js/bootstrap.min.js"); ?>

<?php echo HTML::script("login/js/imagesloaded.pkgd.min.js"); ?>

<?php echo HTML::script("login/js/validator.min.js"); ?>

<?php echo HTML::script("login/js/main.js"); ?>
...
.fxt-template-layout4 .fxt-bg-wrap:before {
  ...
  background: url(<?php echo URL::asset('assets/admin/pages/media/bg/1.jpg'); ?>) rgb(200, 216, 231);
...
</html><?php /**PATH C:\xampp\htdocs\newabsen\resources\views/admin/login.blade.php ENDPATH**/ ?>