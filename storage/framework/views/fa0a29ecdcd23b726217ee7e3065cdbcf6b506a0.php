...
<div class="label label-success" style="background-color: #2c2c2c;margin-bottom:3px;    display: block;">IP Masuk: <?php echo e($row->clock_in_ip_address ?? "Tidak Ada"); ?></div>
<div class="label label-success" style="background-color: #2c2c2c;margin-bottom:3px;    display: block;">IP Pulang: <?php echo e($row->clock_out_ip_address ?? "Tidak Ada"); ?></div>


<?php else: ?>
 <span class="label label-danger">Belum Absen</span>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newabsen\resources\views/admin/attendances/col2_normal_jumat.blade.php ENDPATH**/ ?>