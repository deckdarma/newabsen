...
<?php $__env->startSection('mainarea'); ?>
    ...
    <div class="page-head">
        <div class="page-title"><h1>
                <?php echo e(trans('pages.employees.createTitle')); ?>
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active"><?php echo e(trans('pages.employees.createTitle')); ?></span>
        </li>
    </ul>            <!-- END PAGE HEADER-->
    ...
    <?php else: ?>
        ...
        <?php if($canCreateEmployee): ?>
            ...
            <div class="row ">
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-purple-wisteria">
                                <i class="fa fa-user font-purple-wisteria"></i><?php echo trans('core.personalDetails'); ?>
				...
				<input type="hidden" name="statusmupeg" class="form-control" value="ASN">
                                <div class="form-group">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control dattanomors" name="employeeID"
                                               placeholder="Ketik NIP Tanpa Spasi"
                                               value="<?php echo e(old('employeeID')); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
...
<?php $__currentLoopData = $golonganpeg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<div class="form-group">
                            <label class="col-md-3 control-label">Pegawai Shift<span
                                        class="required">* </span></label>
                            ...
                            <div class="col-md-9">
                                   ...
                                   <select class="form-control" name="shift">
                                    ...
                                    <option selected disabled>Pilih Jenis Pegawai Shift</option>
                                    <option value="1" >YA</option>
                                    <option value="0" >TIDAK</option>
                            
                                </select>
								<small>Jika Anda Memilih YA berarti Pegawai masuk dalam kategori shift</small>
                            </div>
                        </div>	
						<?php else: ?>
