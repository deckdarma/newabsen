...
<td style="background: #5d5086;text-align: center;color: #fff;"><?php echo e($nama_event); ?> Jumat</td>
...
<?php if(( strtotime($pulang) >=  strtotime($jam_pulang_periode_jumat)) and (strtotime($pulang) <= strtotime($jam_akhir_pulang_periode_jumat))): ?>	
...
<?php if($apelpagi ==  "1"): ?>
<td style="color:#fff;text-align: center;background-color: #e07315;"><?php echo e(@apelpagi); ?></td>
<?php else: ?>
...
<td style="background: #5b69bc;text-align: center;color: #fff;"><?php echo e($nama_event); ?></td>
...
<?php if($pulang != "00:00:00"): ?>
<?php if(( strtotime($pulang) >=  strtotime($jam_pulang_periode)) and (strtotime($pulang) <= strtotime($jam_akhir_pulang_periode))): ?>	
<td><center><span class="label label-success">Pulang (<?php echo e($pulang); ?>)</span></center></td>
...
<?php /**PATH C:\xampp\htdocs\newabsen\resources\views/admin/laporanpegawai/data_periode.blade.php ENDPATH**/ ?>