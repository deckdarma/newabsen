...
<?php $__env->startSection('mainarea'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Data Mutasi Keluar</span>
            </li>
...
<div class="note note-warning margin-top-15" style="font-size: 15px; ">
					Anda Dapat Membatalkan Mutasi dengan cara klik tombol Batalkan Mutasi dan melengkapi kembali Bidang dan Jabatan.
                          </div>
                    ...
                    <tr>
					 ...
					 <?php if($task->designation == NULL): ?>
                      ...
                      <td>
						...
						<a class="btn purple btn-sm margin-bottom-5" href="mutasikeluar/<?php echo e($task->id); ?>/edit" ><i class="fa fa-edit"></i><span class="hidden-sm hidden-xs"> Batalkan Mutasi</span></a>
    ...
    font-size: 16px;
    background: #f8f9e6;">Maaf Tidak Ada Pegawai Mutasi Keluar  </td>
		<?php endif; ?>
					</tr>
                  </tbody>                  
                </table>
  ...
  $(function () {
    ...
    function sendOrderToServer() {
      ...
      $.ajax({
        type: "POST", 
        dataType: "json", 
   url: "<?php echo e(route('admin.mutasikeluar.index')); ?>",
 data: {
          order:order,
