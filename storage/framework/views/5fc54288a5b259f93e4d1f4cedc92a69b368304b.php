...
<script type="text/javascript">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a onclick="loadView('<?php echo e(route('admin.pegawaibaru.index')); ?>')">Index Data</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span class="active">      	<?php if($employee->statusmupeg ==""): ?>
             Tarik Data Pegawai
		  <?php else: ?>
			 Tarik Data PHL
			  <?php endif; ?></span>
	                 ...
	                 <div class="">
                                    ...
                                    <a style="margin-bottom:10px;" href="javascript:;" onclick="loadView('<?php echo e(route('admin.pegawaibaru.index')); ?>')"                 " class="btn blue">
		...
		<?php endif; ?>
         <div class="form-group">
          <label class="col-md-3 control-label"><?php echo e(trans('core.department')); ?><span
			...
			<?php if($employee->designation == NULL): ?>
					<?php $__currentLoopData = $departmentno; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<?php else: ?>
					...
					<?php $__currentLoopData = $departmentno; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 	 <option value="<?php echo e($data->id); ?>" <?php if($designation->department_id==$data->id): ?> selected <?php endif; ?>><?php echo e($data->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="statusmupeg">
                                    ...
                                    <option value="ASN" <?php if($employee->statusmupeg==''): ?> selected <?php endif; ?>>ASN</option>
                                    <option value="PHL" <?php if($employee->statusmupeg=='PHL'): ?> selected <?php endif; ?>>PHL
                                    </option>
                                </select>
                            </div>
                        </div>
	     	<?php if($employee->statusmupeg =="PHL"): ?>
...
<?php $__currentLoopData = $golonganpeg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<?php endif; ?>
                  ...
                  <div class="form-group" style="display:none">
                            <label class="col-md-3 control-label"><?php echo e(trans('core.annualOrCredit')); ?> <?php echo help_text("creditLeaves"); ?></label>
                        ...
                        <div class="form-group" style="display:none">
                            <label class="control-label col-md-3"><?php echo e(trans('core.dateOfJoining')); ?></label>
   ...
   <input type="text" name="annual_leave" class="form-control"
                        ...
                        <div class="form-group" style="display:none">
                            <label class="control-label col-md-3"><?php echo e(trans('core.exitDate')); ?> <?php echo help_text("exitDate"); ?></label>
                      ...
                      <hr>
                        <h4><strong>
						       	<?php if($employee->statusmupeg ==""): ?> Jumlah TPP	<?php else: ?> Honorium PHL	<?php endif; ?>
						</strong></h4>
                        <div id="salaryData">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-5">
                                            <?php if(($salary->type=='basic' || $salary->type=='hourly_rate')): ?>
                                                ...
                                                <label class="control-label"><?php if($employee->statusmupeg ==""): ?> Jumlah TPP	<?php else: ?> Jumlah Honor	<?php endif; ?></label>
                                            <?php else: ?>
				...
				Maaf tidak di temukan Honorium Silahkan klik tombol di bawah
						...
						<a href="javascript: ;" onclick="showSalary(<?php echo e($employee->id); ?>)" class="btn green">
                                            <span class="hidden-xs">
											   	<?php if($employee->statusmupeg ==""): ?> Tambahkan TPP 	<?php else: ?> Tambahkan Honor	<?php endif; ?>
							   ...
							   <?php if(($salary->type=='basic')): ?>
                                <div id="salary<?php echo e($salary->id); ?>">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5">
                                            <input type="hidden" class="form-control" name="salary[<?php echo e($salary->id); ?>]"
                                                   value="<?php echo e($salary->salary); ?>">
                                        </div>
  ...
  $(selector).on('keydown keyup change', function (event) {
    ...
    <script>
        ...
        function UpdateDetails(id, type) {
            ...
            var url = "<?php echo e(route('admin.pegawaibaru.update',':id')); ?>";
            url = url.replace(':id', id);
            $.easyAjax({
                type: 'POST',
                url: url,
