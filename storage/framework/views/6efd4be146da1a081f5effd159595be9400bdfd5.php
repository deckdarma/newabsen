...
<?php endif; ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active"> Laporan Pegawai (PHL)</span>
            </li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    <div class="row filter-row">
                        <div class="col-sm-3 col-xs-6">
                            <div class="form-group form-focus">
                                <label class="control-label">Pilih PHL</label>
                               <select class="form-control select2me" name="employee_id" id="employeeID">
                                    <option value="all">Silahkan Pilih PHL</option>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive" id="laporphl-sheet">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('footerjs'); ?>
    ...
    <script type="text/javascript">
       ...
       var filter = () => {
            ...
            var url = "<?php echo e(route('admin.laporphl.filter')); ?>";
            $.easyAjax({
                type: 'POST',
                url: url,
                container: '#laporphl-sheet',
                data: data,
                success: function (res) {
                    if (res.status === 'success') {
                        $('#laporphl-sheet').html(res.data);
                    }
                }
            });
        };
