...
<div id="id-elemen-yang-ingin-di-print"> 
						...
						<div style="text-align: center;font-weight: bold;font-size: 20px;text-transform: uppercase;margin-top: -5px;"><?php echo e($loggedAdmin->company->company_name); ?> </div>
													<div style="text-align: center;font-weight: bold;font-size: 15px;text-transform: uppercase;margin-top: -3px;">NAMA : <?php echo e($namapegawai); ?> / NIP : <?php echo e($nippegawai); ?></div>
...
<?php echo $__env->make('admin.laporanpegawai.data_periode', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- ELSE PERIODE -->  <?php else: ?>

<?php echo $__env->make('admin.laporanpegawai.data_normal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>	
<!-- END PERIODE --> <?php endif; ?>
...
<td rowspan="2">PPh 21<br><div style="color:red"><?php echo e($data->pph_pegawai); ?></div></td>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
...
<tr>
<td style="vertical-align: middle;width: 50px;"><?php echo e($data->jumlah_prestasi_kehadiran); ?></td>

<td style="vertical-align: middle;width: 70px;">
<input type="hidden" style="width: 50px;" value="0.386" id="a2" readonly=""><?php echo e($data->jumlah_prestasi_kinerja); ?></td>

<td style="vertical-align: middle;width: 60px;"><?php echo e($data->total_prestasi_kinerja); ?></td>

<td style="vertical-align: middle;"><?php echo e($data->pemotongan_cuti_kinerja); ?></td>

<td style="vertical-align: middle;"><?php echo e($data->pemotongan_hukuman_kinerja); ?></td>

<td style="vertical-align: middle;"><?php echo e($data->total_pemotongan_kinerja); ?></td>

<td style="vertical-align: middle;width: 50px;"><?php echo e($data->total_bobot_kinerja); ?></td>
...
<?php /**PATH C:\xampp\htdocs\newabsen\resources\views/admin/laporanpegawai/load.blade.php ENDPATH**/ ?>