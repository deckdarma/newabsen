...
return [
    ...
    'appUpdate' => [
        "title" => "Maintinace Aplikasi",
        "text" => "Silahkan Klik Enable/Disable"
    ],
	
	   'TariKData' => [
        "title" => "Penarikan Data Absensi",
        "text" => "Jika anda memilih OTOMATIS Berarti anda membebankan penarikan data tampilan layar di masing-masing OPD namun jika anda memilih MANUAL maka anda harus menarik data secara manual"
    ],
