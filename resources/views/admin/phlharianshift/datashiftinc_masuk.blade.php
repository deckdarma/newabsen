...
@if($status422 !=  "1")
<div class="label  label-{{  $status422 }}">Masuk: <i class="fa fa-clock-o"></i> {{ $row->clock_in }}</div>
...
@else
	 ...
	 <div class="label label-success" style="background-color: #d33636;margin-bottom:3px;    display: block;">Blm Pulang</div>
@endif
