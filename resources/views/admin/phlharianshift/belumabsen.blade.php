        ...
        <div class="col-md-12">
		 ...
		 <a href="javascript:printDiv('id-elemen-yang-ingin-di-print');" class="btn green"> <i class="fa fa-print"></i>  Print <span
			...
			$jumlahbelum = $datashiflihatcount-$dataabsenpresent; ?>		
                     		 <a href="javascript:printDiv('id-elemen-yang-ingin-di-print');" class="btn green"> <i class="fa fa-print"></i>  Print <span
                                        id="date_heading">( {{ $jumlahbelum }} ) PHL yang Belum Absen</span></a>
                            </div>
    ...
    <script>
        ...
        function loadDataTable() {
            table = $('#attendanceTable').dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "{{ URL::route("admin.phlharianlapor.ajax_attendance_belum") }}",
                    "data": function (d) {
...
//			 $('#halfDayLabel').show(100);
        ...
        $('#date_change').datepickerabsen({
            ...
            var url = "{{ route("admin.phlharianshift.create", "#id") }}";
        ...
        function ajaxUpdateAttendance() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var route = "{{ route("admin.phlharianshift.create", "#id") }}";
