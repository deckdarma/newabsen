...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active"> Laporan Harian PHL (Shift)</span>
            </li>
        </ul>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet light bordered">
                <div class="portlet-body form">
                        ...
                        <div class="table-toolbar margin-top-15">
                            <div class="row">
                                <div class="col-md-4">
                                    {!! Form::open(['route'=>["admin.phlharianshift.create"], 'method' => 'GET', 'class' => "form-inline", 'id' => "new_date"]) !!}
                                    <div class="btn-group">
		 ...
		 <a href="javascript:printDiv('id-elemen-yang-ingin-di-print');" class="btn green"> <i class="fa fa-print"></i>  Print <span
							...
							<div class="yeprint">
							<div style="text-align: center;font-weight: bold;font-size: 25px;">	LAPORAN HARIAN PHL (SHIFT)        </div>
						...
						<tbody>               
@foreach ($dataabsenlihatss as $data)			    


@if ($data->idemp ==  $data->idshift)
	@if ($data->statusss == 'alpha')	
<tr>
<td style="width:25% !important">{{  $data->full_name }}<div style="font-size: 11px;">PHL</div></td>

<td >
<span class="label label-danger" style="    background-color: #cf1212;">Belum Ada Jadwal Shift</span>
</td>
<td >
-
</td>
    ...
    <script>
        ...
        function loadDataTable() {
            table = $('#attendanceTable').dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "{{ URL::route("admin.phlharianlapor.ajax_attendance") }}",
                    "data": function (d) {
                        d.date = $('#attendence_date').val();
                    }
                },
				"oLanguage" : {
					"sEmptyTable" : "Tidak Di Temukan Jadwal Shift Pada Tanggal ini, Berikut  Di Bawah PHL yang belum ada Shift"
				},
                "aaSorting": [[0, "asc"]],
                "autoWidth": true,
                "autoHeight": true,
...
//			 $('#halfDayLabel').show(100);
        ...
        $('#date_change').datepickerabsen({
            ...
            var url = "{{ route("admin.phlharianshift.edit", "#id") }}";
...
$('.datePicker').datepickerabsen({ beforeShowDay: unavailable });
        function ajaxUpdateAttendance() {
            ...
            var url = "{{ route("admin.phlharianshift.update", "#id") }}";
            url = url.replace("#id", date);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var route = "{{ route("admin.phlharianshift.edit", "#id") }}";
