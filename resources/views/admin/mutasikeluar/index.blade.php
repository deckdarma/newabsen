                    ...
                    <tr>
					 ...
					 @if ($task->designation == NULL)
                      ...
                      <td>
						...
						<a class="btn purple btn-sm margin-bottom-5" href="mutasikeluar/{{ $task->id }}/edit" ><i class="fa fa-edit"></i><span class="hidden-sm hidden-xs"> Batalkan Mutasi</span></a>
  ...
  $(function () {
    ...
    function sendOrderToServer() {
      ...
      $.ajax({
        type: "POST", 
        dataType: "json", 
   url: "{{ route('admin.mutasikeluar.index') }}",
 data: {
          order:order,
          _token: '{{csrf_token()}}'
        },
