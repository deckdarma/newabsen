...
<td style="  padding: 10px;  text-align: left;vertical-align: middle;"><b>{{ $payrolls->full_name }}<br></b>{{ $payrolls->employeeID }}</td>	
 @if ($caricount =="0")	
<td colspan="13" style="background: #fbf7f7;text-align: center;">BELUM ADA REKAP PADA BULAN {{ $databulan }} TAHUN {{ $datatahun }}</td>	
...
<td style=" vertical-align: middle; ">{{ $payrolls->pemotongan_cuti_kinerja }}</td>
<td style=" vertical-align: middle; ">{{ $payrolls->pemotongan_hukuman_kinerja }}</td>
<td style=" vertical-align: middle; ">{{ $payrolls->total_pemotongan_kinerja }}</td>
<td style=" vertical-align: middle; ">{{ $payrolls->total_bobot_kinerja }}</td>
<td style=" vertical-align: middle; ">
<?php
