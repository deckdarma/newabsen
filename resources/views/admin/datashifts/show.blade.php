...
<div class="page-head">
    <div class="page-title">
        <h1>
            @lang("pages.datashifts.indexTitle") - {{ $employee->full_name }}
        </h1>
    </div>
</div>
<div class="page-bar">
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a onclick="loadView('{{ route('admin.datashifts.index') }}')" >@lang("pages.datashifts.indexTitle")</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span class="active">@lang("pages.datashifts.editTitle")</span>
        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="alert alert-danger text-center">
                                            <strong>{{trans('core.datashift')}}</strong>
                                            <div id="datashiftReport">-</div>
                                        </div>
                                    </div>
                                    <!--/span-->
...
<script>
    ...
    function showReport() {
        ...
        var url = "{{ route('admin.datashift.report',':id') }}";
        ...
        $.ajax({
            ...
            if (response.success == "success") {
                ...
                $('#datashiftReport').html(response.presentByWorking);
                $('#datashiftPerReport').html(response.datashiftPerReport);
    ...
    function redirect_to() {
        ...
        var url = "{{ route('admin.datashifts.show',':id') }}";
