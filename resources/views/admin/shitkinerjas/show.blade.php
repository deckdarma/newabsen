...
@section('mainarea')
			...
			<div class="page-bar">
				<ul class="page-breadcrumb breadcrumb">
					...
					<li>
						<a href="{{ route('admin.shitkinerjas.index') }}">Shitkinerja</a>
					...
					<div class="portlet-body">
							<div class="row">
										...
										<div class="col-md-2">
											<div class="form-group">
												<div class="col-md-9">
												 {!! HTML::image($shitkinerja->employee->profile_image_url,'ProfileImage',['height'=>'100px']) !!}
									...
									<div class="col-md-4">
										<div class="form-group">
											<div class="col-md-9">
												<ul>
													<li><h4>EmployeeID: {{$shitkinerja->employee->employeeID}}</h4></li>
													<li><h4>Name:  {{$shitkinerja->employee->full_name}}</h4></li>
													<li><h4>Month: {{date('F', strtotime($shitkinerja->month . '01'));}}</h4></li>
													<li><h4>Year:  {{$shitkinerja->year}}</h4></li>
												</ul>
											</div>
										</div>
									</div>
                                        ...
                                        {{--END ERROR MESSAGE BOX--}}
                        					...
                        					<div class="portlet-body">
                										...
                										<div class="form-group">
                												...
                												<label class="control-label">{{$shitkinerja->overtime_hours}}</label>
                										...
                										<div class="form-group">
                												...
                												<div class="col-md-8 margin-bottom-10">
                												<label class="control-label">{{$shitkinerja->overtime_pay}}</label>
                										...
                										<div class="form-group">
                												...
                												<div class="col-md-8 margin-bottom-10">
                												<label class="control-label">{{number_format($shitkinerja->basic, 2)}}</label>
                												</div>
                										</div>
														<div class="form-group">
																<label class="control-label col-md-2">Expense Claim( {{$loggedAdmin->company->currency_symbol}} ):</label>
																<div class="col-md-8 margin-bottom-10">
																<label class="control-label">{{number_format($shitkinerja->expense, 2)}}</label>
																</div>
														</div>
                										<!--/span-->
                									...
                									<div class="portlet box blue-hoki">
                										...
                										<div class="portlet-body">
                											...
                											<div class="form-group">
                													...
                													<div class="col-md-8 margin-bottom-10">
                														<label class="control-label">{{number_format($shitkinerja->total_allowance, 2)}}</label>
                											...
                											<div class="form-group">
                													...
                													<div class="col-md-8 margin-bottom-10">
                														<label class="control-label">{{number_format($shitkinerja->total_deduction, 2)}}</label>
                											...
                											<div class="form-group">
                													...
                													<div class="col-md-8 margin-bottom-10">
                														<label class="control-label">{{number_format($shitkinerja->net_salary, 2)}}</label>
