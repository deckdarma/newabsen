...
@section('mainarea')
    ...
    <div class="page-head">
      ...
      Index Kinerja dan Kehadiran Shift
            </h1></div>
    </div>
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Index Kinerja dan Kehadiran Shift</span>
            </li>
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row ">
                            <div class="col-md-3">
                                <a class="btn green" onclick="loadView('{{ route('admin.shitkinerjas.create') }}')">
                           Tambah Kinerja dan Kehadiran Shift
                                    <i class="fa fa-plus"></i> </a>
                            </div>
     <div class="col-md-6 text-right"></div>
                            <div class="col-md-3">
                                <select class="form-control select2me" name="employee_id" id="employeeID">
                                    <option value="all">Pencarian Pilih Pegawai Shift</option>
                    ...
                    <table style="border: 1px solid #c2cad8;" class="table table-striped table-bordered table-hover" id="shitkinerja">
                        <thead>
                        <tr>
                            <th> #</th>
    ...
    <div id="reportModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {!!  Form::open(array('route'=>'admin.shitkinerja_report','class'=>'form-horizontal','method'=>'POST','id'=>'salary-form')) !!}
...
@section('footerjs')
    ...
    <script>
        ...
        function loadTable() {
            ...
            var table = $('#shitkinerja').dataTable({
                {!! $datatabble_lang !!}
                processing: true,
                serverSide: true,
                destroy: false,
                ...
                "ajax": "{!!  route('admin.ajax_shitkinerjas')  !!}?employee_id=" + employee_id,
                "autoWidth": false,
                "aaSorting": [[6, "desc"]],
                "columns": [
        ...
        function del(id, title) {
            ...
            $("#deleteModal").find('#info').html('@lang("messages.shitkinerjaDeleteConfirm")');

            $('#deleteModal').find("#delete").off().click(function () {

                var url = "{{ route('admin.shitkinerjas.destroy',':id') }}";
