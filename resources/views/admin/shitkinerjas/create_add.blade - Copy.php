...
?> 
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" name="allowance[]" class="form-control" value="Jumlah = {{ $hitungcountketerangan }}x" readonly></div>
...
@if ($data->num_of_leave2 =="1") 
            ...
            <div class="form-group" style="margin-bottom: 0px;" id="deduction{{ $data->id }}">
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" name="deduction[]" class="form-control" value="Jumlah = {{ $hitung_skor1 }}x" readonly></div>
...
@if ($data->num_of_leave2 =="2") 
            ...
            <div class="form-group" style="margin-bottom: 0px;" id="deduction{{ $data->id }}">
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" class="form-control" name="deduction[]" value="Jumlah = {{ $hitung_skor2 }}x" readonly></div>
...
@if ($data->num_of_leave2 =="3") 
            ...
            <div class="form-group" style="margin-bottom: 0px;" id="deduction{{ $data->id }}">
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" class="form-control" name="deduction[]" value="Jumlah = {{ $hitung_skor3 }}x" readonly></div>
...
@if ($data->num_of_leave2 =="4") 
            ...
            <div class="form-group" style="margin-bottom: 0px;" id="deduction{{ $data->id }}">
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" class="form-control" name="deduction[]" value="Jumlah = {{ $hitung_skor4 }}x" readonly></div>
...
@if ($data->num_of_leave2 =="7") 
            ...
            <div class="form-group" style="margin-bottom: 0px;" id="deduction{{ $data->id }}">
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" class="form-control" name="deduction[]" value="Jumlah = {{ $cepatpulangcount }}x" readonly></div>
...
@if ($data->num_of_leave2 =="8") 
            ...
            <div class="form-group" style="margin-bottom: 0px;" id="deduction{{ $data->id }}">
				...
				<div class="col-md-5 margin-bottom-1" > <input type="text" class="form-control" name="deduction[]" value="Jumlah = {{ $hitungjumlahket }}x" readonly></div>
...
<div class="col-md-12 text-center">
			...
			<div class="portlet-title">
            <div class="caption font-dark">
   TABEL PERHITUNGAN SKOR PRESTASI KEHADIRAN
            </div>
        </div>
                <div class="portlet-body">
<div style="
    ...
    margin-bottom: 20px;
    color: #ff0000;
">KETERENGAN: TANPA KETERANGAN YANG SAH + CUTI TAHUNAN + TUGAS BELAJAR + DINAS LUAR DAERAH (MASUK DALAM HITUNGAN SKOR 10)</div>
...
?>	
		...
		<td style="font-size:11px">{{ number_format($hasil_sk1,2) }}<br>
		{{ $hitung_skor1 }} 
		<br>
		{{ $jumlahharikerja }}			
		</td>
...
?>	
		...
		<td style="font-size:11px">{{ number_format($hasil_sk2,2) }}<br> {{ $hitung_skor2 }}
		<br>
			{{ $jumlahharikerja }}			
		</td>
	@endif	
...
?>
		...
		<td style="font-size:11px">{{ number_format($hasil_sk3,2) }}<br> {{ $hitung_skor3 }} 
		<br>
			{{ $jumlahharikerja }}				
		</td>
	@endif	
...
?>	
		...
		<td style="font-size:11px">{{ number_format($hasil_sk4,2) }}<br> {{ $hitung_skor4 }}
		<br>
		{{ $jumlahharikerja }}			
		</td>
	@endif		
...
?>
		...
		<td style="font-size:11px">{{ number_format($hasil_sk7,2) }}<br> {{ $cepatpulangcount }} 
		<br>
		{{ $jumlahharikerja }}		
		</td>
@endif	
...
$hitungRSCS = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuRSCS."' AND datashift.status='hadir' AND attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));


$aRSCS=$data->potongan_shift;
$bRSCS=$hitungRSCS;
...
?>
		...
		<td style="font-size:11px">{{ number_format($hasil_skRSCS,2) }}<br> {{ $hitungRSCS }}	
		<br>
			{{ $jumlahharikerja }}			
		</td>
@endif	
@endforeach
	...
	@foreach ($leavetype as $data)		
@if ($data->singkat =="CDTN")
<?php
$datakuRSCDTN  = $data->singkat;
$hitungRSCDTN = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuRSCDTN."' AND datashift.status='hadir' AND attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));




$aRSCDTN=$data->potongan_shift;
...
?>
		...
		<td style="font-size:11px">{{ number_format($hasil_skRSCDTN,2) }}<br> {{ $hitungRSCDTN }}	
		<br>
			{{ $jumlahharikerja }}			
		</td>
@endif	
...
$hitungRSCB = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuRSCB."' AND datashift.status='hadir' AND attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));



$aRSCB=$data->potongan_shift;
$bRSCB=$hitungRSCB;
...
$hitungRSDKS = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuRSDKS."' AND datashift.status='hadir' AND attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));




$aRSDKS=$data->potongan_shift;
$bRSDKS=$hitungRSDKS;
...
?>
		...
		<td style="font-size:11px">{{ number_format($hasil_skRSDKS,2) }}<br> {{ $hitungRSDKS }}	
		<br>
		{{ $jumlahharikerja }}		
		</td>
@endif
...
$hitungRSTB = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuRSTB."' AND datashift.status='hadir' AND attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));
...
$hitungRSCT = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuRSCT."' AND datashift.status='hadir' AND attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));
...
@if ($data->singkat =="DLD")
<?php
$datakuDLD  = $data->singkat;
$hitungDLD = count(DB::select(DB::raw("SELECT datashift.date FROM attendance LEFT JOIN datashift ON attendance.date = datashift.date WHERE attendance.leaveType ='".$datakuDLD."' AND datashift.status='hadir' AND  attendance.status ='absent' AND attendance.application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND datashift.employee_id=" . $noidapegs ." AND attendance.employee_id=" . $noidapegs)));
...
$cRSTB= $hitungRSTB;
$dDLD= $hitungDLD;
$datatanpakethitung = $aTNPA+$bRSCT+$cRSTB+$dDLD;
?>
...
$cektotalskorpeg = number_format($total_skorpegawaifinal,2);
