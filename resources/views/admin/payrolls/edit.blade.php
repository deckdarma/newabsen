...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a onclick="loadView('{{ route('admin.payrolls.index') }}')">Index</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
...
@if($payroll->employee->shift == "0")
@else
<script type="text/javascript">

    window.location.replace("../../shitkinerjas/{{ $payroll->id }}/edit");
</script>
...
<div class="row">
        <div class="col-md-12 text-center">
            <div class="portlet light bordered">
             ...
             <div style="text-align: center;font-weight: bold;font-size: 25px;">	FORMULIR KINERJA DAN KEHADIRAN   ({{ $payroll->employee->statusmupeg }})    </div>
...
@if($payroll->employee->statusmupeg == "ASN")
 / NIP : {{ $payroll->employee->employeeID }} 
@endif
...
@if($loggedAdmin->company->datashift==1)	
@foreach ($attendanceas_shift as $data)
<?php
//shift
...
<input type="number"  id="b2" name="jumlah_prestasi_kinerja" value="{{$payroll->jumlah_prestasi_kinerja}}" min="0" step="5" max="60" style="width: 70px;    text-align: center;" class="form-control  sum" id="b2" required>
</td>
...
<input oninput="process(this)" type="number" style="width: 60px;text-align: center;" class="form-control  sum" name="pemotongan_cuti_kinerja" value="{{$payroll->pemotongan_cuti_kinerja}}" id="c2">
</td>

<td style="vertical-align: middle;">
<input oninput="process(this)" type="number" style="width: 60px;text-align: center;" class="form-control  sum" name="pemotongan_hukuman_kinerja" value="{{$payroll->pemotongan_hukuman_kinerja}}" id="d2">
</td>
...
<td style="vertical-align: middle;">
<input oninput="process(this)" type="number" style="width: 100%;text-align: center;" class="form-control" name="tambahan_tpp_rp" value="{{$payroll->tambahan_tpp_rp}}" id="hasiltpp">
<input oninput="process(this)" type="hidden" style="width: 100%;text-align: center;" class="form-control"  value="{{$payroll->tambahan_tpp_rp}}" id="hasil9">
</td>
...
<input oninput="process(this)" type="hidden" style="width: 60px;text-align: center;" class="form-control  sum" name="pemotongan_cuti_kinerja" value="{{$payroll->pemotongan_cuti_kinerja}}" id="c2">
<input oninput="process(this)" type="hidden" style="width: 60px;text-align: center;" class="form-control  sum" name="pemotongan_hukuman_kinerja" value="{{$payroll->pemotongan_hukuman_kinerja}}" id="d2">
...
<input oninput="process(this)" type="hidden" style="width: 100%;text-align: center;" class="form-control" name="tambahan_tpp_rp" value="{{$payroll->tambahan_tpp_rp}}" id="hasiltpp">
<input oninput="process(this)" type="hidden" style="width: 100%;text-align: center;" class="form-control"  value="{{$payroll->tambahan_tpp_rp}}" id="hasil9">
...
@endif
     ...
     <input type="hidden" class="form-control"  name="pay_date" value="{{$payroll->pay_date}}" readonly> 		
