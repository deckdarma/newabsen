...
<div style="text-align: center;font-weight: bold;font-size: 25px;">	FORMULIR KINERJA DAN KEHADIRAN  @foreach ($datanama as $data)   ({{ $data->statusmupeg }})   @endforeach	 </div>
...
?> 
				...
				<div class="col-md-5 margin-bottom-10" > <input type="text" name="allowance[]" class="form-control" value="Jumlah = {{ $hitungcountketerangan }}x" readonly></div>
...
<!-- STAR PERIODE --> @if($data->tanggalperiode ==  $data->datatanggal)
@if ($tampilkanhari_count == "saturday" ) @else   
@if ($tampilkanhari_count == "sunday" ) @else   
@if ($tampilkanhari_count == "friday" )
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn1s1 }}  {{ $datapersen  }}%" readonly></div>
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn2s2 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn3s3 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn4s4 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn5s5 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn6s6 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn7s7 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
?>
            <div class="form-group" id="deduction{{ $data->id }}">
				...
				<div class="col-md-3 margin-bottom-10" > <input type="text" class="form-control" value="{{ $catatn8s8 }}  {{ $datapersen  }}%" readonly></div>
                <div class="col-md-2  margin-bottom-10">
...
<div class="form-group" id="allowance25">
...
?>	
	...
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitung_skor1}} <br> <b>{{ number_format($hasil_sk1,2) }}</b> 
...
?>	
	...
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitung_skor2}} <br> <b>{{ number_format($hasil_sk2,2) }}</b> 
...
?>
	...
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitung_skor3}} <br> <b>{{ number_format($hasil_sk3,2) }}</b> 
...
?>	
	...
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitung_skor4}} <br> <b>{{ number_format($hasil_sk4,2) }}</b> 
...
?>
	...
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $cepatpulangcount}} <br> <b>{{ number_format($hasil_sk7,2) }}</b> 
...
$hasilnCSsCS = $catatnCSsCS/100;

$aCS=$datapersen;
$bCS=$hasilnCSsCS;
$hasil_skRSCS = $aCS*$bCS;

?>
	
	<td style="font-size:11px;width:6%">
	
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitungRSCS}} <br> <b>{{ number_format($hasil_skRSCS,2) }}</b> 
...
$nCDTN=$data->potongan;
$sCDTN=$hitungRSCDTN;
$catatnCDTNsCDTN = $nCDTN*$sCDTN;

$hasilnCDTNsCDTN = $catatnCDTNsCDTN/100;

$aCDTN=$datapersen;
$bCDTN=$hasilnCDTNsCDTN;
$hasil_skRSCDTN = $aCDTN*$bCDTN;

?>
	
	<td style="font-size:11px;width:6%">
	
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitungRSCDTN}} <br> <b>{{ number_format($hasil_skRSCDTN,2) }}</b> 
...
$hasilnCBsCB = $catatnCBsCB/100;

$aCB=$datapersen;
$bCB=$hasilnCBsCB;
$hasil_skRSCB = $aCB*$bCB;
?>
	
	<td style="font-size:11px;width:6%">
	
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitungRSCB}} <br> <b>{{ number_format($hasil_skRSCB,2) }}</b> 
...
$nDKS=$data->potongan;
$sDKS=$hitungRSDKS;
$catatnDKSsDKS = $nDKS*$sDKS;

$hasilnDKSsDKS = $catatnDKSsDKS/100;

$aDKS=$datapersen;
$bDKS=$hasilnDKSsDKS;
$hasil_skRSDKS = $aDKS*$bDKS;
?>
	
	<td style="font-size:11px;width:6%">
	
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $hitungRSDKS}} <br> <b>{{ number_format($hasil_skRSDKS,2) }}</b> 
...
$hitungDLD = count(DB::select(DB::raw("SELECT holidays.date FROM attendance LEFT JOIN holidays ON attendance.date = holidays.date WHERE attendance.leaveType ='".$datakuDLD."' AND attendance.status ='absent' AND application_status ='approved' AND MONTH(attendance.date)=" . $databulan . "  AND YEAR(attendance.date)=" . $datatahun . " AND attendance.employee_id=" . $noidapegs)));
...
?>
	...
	{{ $data->potongan }}% x {{ $datapersen }}% <br>{{ $datatanpakethitung}} <br> <b>{{ number_format($hasil_sk8,2) }}</b> 
...
<td style="font-size:11px;width:7%">
	...
	{{ $jumlahskorfinal }} x 100 <br>= <br> <b>{{ number_format($JMSK,2) }} %</b> 
...
?>
		...
		<td style="    vertical-align: middle;    font-weight: bold;">
									...
									{{ $datapersen }} - {{ $jumlahskorfinal }} x 100  <br>= <br> {{ $cektotalskorpeg }}
