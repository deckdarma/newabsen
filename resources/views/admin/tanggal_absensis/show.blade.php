<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title"><strong><i
                        class="la la-plus"></i>Lihat Data  Periode {{ $tanggal_absensi->judul_nama }}</strong></h4>
    </div>
...
">
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">DATA UTAMA</div>
                    ...
                    <input type="hidden" name="leaveformType" id="leaveformType" value="date_range">
						    <input type="hidden" name="company_id" id="company_id" value="{{ $tanggal_absensi->company_id }}" value="1">

							
									<div class="col-md-12">Nama Periode <span class="required">*  </span>
                            <input class="form-control" type="text"  value="{{ $tanggal_absensi->judul_nama }}" placeholder="Ketik Nama Absensi" disabled>
							<span class="help-block"></span>
                            </div>
							
							         <div class="col-md-6">Tanggal  Mulai Periode  <span class="required">*  </span>
				                   <input class="form-control" type="text"  value="{{ $tanggal_absensi->start_date }}" 
                                           placeholder="Tanggal Mulai" readonly disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Tanggal Akhir Periode <span class="required">*  </span>
                          <input class="form-control" type="text"  value="{{ $tanggal_absensi->end_date }}" 
                                           placeholder="Tanggal Berakhir" readonly disabled>
							<span class="help-block"></span>
                            </div>
									<div class="col-md-12" style="padding-bottom:20px;">Total Hari
                       
                            <span id="daysSelected" class="badge rounded-2x badge-red">{{ $tanggal_absensi->days }}</span>
						...
						<div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Masuk Senin-Kamis</div>
                            ...
                            <div class="col-md-6">Mulai Jam Masuk <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text"   value="{{ $tanggal_absensi->jam_masuk }}"  disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6" style="padding-bottom:10px;">Tutup Absen Masuk  <span class="required">*  </span>
                            <input class="form-control " type="text"   value="{{ $tanggal_absensi->jam_akhir_masuk }}"   disabled>
							<span class="help-block"></span>
                            </div>
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Masuk Juma'at</div>
                            ...
                            <div class="col-md-6">Mulai Jam Masuk <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text"    value="{{ $tanggal_absensi->jam_masuk_jumat }}"  disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6" style="padding-bottom:10px;">Tutup Absen Masuk  <span class="required">*  </span>
                            <input class="form-control " type="text"   value="{{ $tanggal_absensi->jam_akhir_masuk_jumat }}"   disabled>
							<span class="help-block"></span>
                            </div>
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Pulang Senin-Kamis</div>
                            ...
                            <div class="col-md-6">Mulai Jam Pulang <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text" value="{{ $tanggal_absensi->jam_pulang }}"   disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6" style="padding-bottom:10px;">Tutup Absen Pulang  <span class="required">*  </span>
                            <input class="form-control " type="text" value="{{ $tanggal_absensi->jam_akhir_pulang }}"   disabled>
							<span class="help-block"></span>
                            </div>
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Pulang Juma'at</div>
                            ...
                            <div class="col-md-6">Mulai Jam Pulang <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text"  value="{{ $tanggal_absensi->jam_pulang_jumat }}"  disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6" style="padding-bottom:10px;">Tutup Absen Pulang  <span class="required">*  </span>
                            <input class="form-control " type="text"  value="{{ $tanggal_absensi->jam_akhir_pulang_jumat }}"   disabled>
							<span class="help-block"></span>
                            </div>
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">{{ $data->dataSkor }} Senin s/d Kamis</div>
							...
							<input class="form-control" type="hidden"  value="{{$tanggal_absensi->$cariid}}"  disabled>
                             <input class="form-control " type="text"   value="{{$tanggal_absensi->$carimasuk}}"  disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Jam Akhir Skors  <span class="required">*  </span>
                            <input class="form-control " type="text" value="{{$tanggal_absensi->$caripulang}}"     disabled>
							<span class="help-block"></span>
                            </div>
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">{{ $data->dataSkor }} Jumat</div>
                            ...
                            <div class="col-md-6">Jam Mulai Skors  <span class="required">*  </span>
							<input class="form-control" type="hidden"  value="{{$tanggal_absensi->$cariid_jumat}}"    disabled>
                             <input class="form-control " type="text" value="{{$tanggal_absensi->$carimasuk_jumat}}"  disabled>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Jam Akhir Skors  <span class="required">*  </span>
                            <input class="form-control " type="text"  value="{{$tanggal_absensi->$caripulang_jumat}}"   disabled>
							<span class="help-block"></span>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-offset-3 col-md-9">
					  <div style="padding-bottom:10px;">  </div>	
					   @if($tanggal_absensi->application_status=='pending')
					             <input type="submit" name="application_status" data-loading-text="@lang("core.updating")..." class="btn green" value="Terima / Setujui" data-toggle="modal" href="#static_approve_tampilan" onclick="show_approve_tampilan({{ $tanggal_absensi->id }});return false;">
                        <input type="submit" name="application_status" data-loading-text="@lang("core.updating")..." class="btn red" value="Batalkan / Tolak" data-toggle="modal" href="#static_reject_tampilan" onclick="show_reject_tampilan(' {{ $tanggal_absensi->id }} ');return false;">
                    @endif
