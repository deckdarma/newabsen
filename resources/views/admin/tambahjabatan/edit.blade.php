...
$tambahjabatan = count(DB::select(DB::raw("SELECT * FROM employees WHERE  id='".$idget."' AND company_id ='".$caricompanyid."' "))); 
...
@endif
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a onclick="loadView('{{route('admin.employees.index')}}')">Index Data</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span class="active"> Form Batalkan Mutasi</span>
	                 ...
	                 <div class="">
                                    ...
                                    <a style="margin-bottom:10px;" href="javascript:;" onclick="loadView('{{route('admin.employees.index')}}')"                 " class="btn blue">
...
@if($employee->golongan==$data->id) {{ $data->golonganPeg }} @endif
 ...
 <b>{{ $employee->full_name }}</b> Tidak memiliki jabatan harap tambahkan jabatan di bawah, pilih nama bidang dan pilih jabatan</div>
      ...
      <div class="actions" style="text-align: center;">
                        <a href="javascript:;"
                           ...
                           class="btn btn-lg btn-success ">
                            <i class="fa fa-save"></i> Lanjutkan Input Jabatan </a>
                    </div>
...
@section('footerjs')
    ...
    <script>
        ...
        function UpdateDetails(id, type) {
            ...
            var url = "{{ route('admin.tambahjabatan.update',':id') }}";
            ...
            $.easyAjax({
                ...
                file: true,
              	...
              	window.location.replace("../../tambahjabatan");
