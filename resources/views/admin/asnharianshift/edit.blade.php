...
<tr>
<td style="width:25% !important">{{  $data->full_name }}<div style="font-size: 11px;">NIP: {{  $data->nippeg }}</div></td>
    ...
    <script>
        ...
        function loadDataTable() {
            table = $('#attendanceTable').dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "{{ URL::route("admin.asnharianlapor.ajax_attendance") }}",
                    "data": function (d) {
                        d.date = $('#attendence_date').val();
                    }
                },
				"oLanguage" : {
					"sEmptyTable" : "Tidak Di Temukan Jadwal Shift Pada Tanggal ini, Berikut  Di Bawah ASN yang belum ada Shift"
				},
                "aaSorting": [[0, "desc"]],
                "autoWidth": true,
                "autoHeight": true,
...
//			 $('#halfDayLabel').show(100);
        ...
        $('#date_change').datepickerabsen({
            ...
            var url = "{{ route("admin.asnharianshift.edit", "#id") }}";
        ...
        function ajaxUpdateAttendance() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var route = "{{ route("admin.asnharianshift.edit", "#id") }}";
