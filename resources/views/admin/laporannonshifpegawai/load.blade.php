...
<div id="id-elemen-yang-ingin-di-print"> 
						...
						<div style="text-align: center;font-weight: bold;font-size: 20px;text-transform: uppercase;margin-top: -5px;">{{ $loggedAdmin->company->company_name }} </div>
													<div style="text-align: center;font-weight: bold;font-size: 15px;text-transform: uppercase;margin-top: -3px;">NAMA : {{ $namapegawai }} / NIP : {{ $nippegawai }}</div>
...
@include('admin.laporannonshifpegawai.data_periode')
<!-- ELSE PERIODE -->  @else

@include('admin.laporannonshifpegawai.data_normal')	
<!-- END PERIODE --> @endif
