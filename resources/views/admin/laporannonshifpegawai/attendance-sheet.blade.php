...
@endif
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Laporan Pegawai Non Shift (ASN)</span>
            </li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive" id="laporpegnonshift-sheet">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('footerjs')
    ...
    <script type="text/javascript">
       ...
       var filter = () => {
            ...
            var url = "{{ route('admin.laporpegnonshift.filter') }}";
            $.easyAjax({
                type: 'POST',
                url: url,
                container: '#laporpegnonshift-sheet',
                data: data,
                success: function (res) {
                    if (res.status === 'success') {
                        $('#laporpegnonshift-sheet').html(res.data);
                    }
                }
            });
        };
