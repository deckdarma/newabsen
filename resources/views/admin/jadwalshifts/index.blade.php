...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Pengaturan  Jadwal Shift</span>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="Jadwalshift">
                        <thead>
                        <tr>
...
@section('footerjs')
    ...
    <script>
        ...
        var table = $('#Jadwalshift').dataTable({
            "cache": true,
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "order": [[1, "asc"]],
            "ajax": "{{ URL::route("admin.jadwalshifts.ajax_list") }}",
            "aoColumns": [
        ...
        function del(id, name) {
            ...
            $('#deleteModal').find("#delete").off().click(function () {
                ...
                var url = "{{ route('admin.jadwalshifts.destroy',':id') }}";
        ...
        function showEdit(id) {
            var url = "{{ route('admin.jadwalshifts.edit',':id') }}";
            url = url.replace(':id', id);
        ...
        function showAdd() {
            var url = "{{ route('admin.jadwalshifts.create') }}";
            $.ajaxModal('#showModal', url);

        }

        function addUpdateJadwalShift(id) {

            if (typeof id != 'undefined') {
                var url = "{{ route('admin.jadwalshifts.update',':id') }}";
                url = url.replace(':id', id);
            } else {
                url = "{{route('admin.jadwalshifts.store')}}";
            }
            $.easyAjax({
                type: 'POST',
                url: url,
