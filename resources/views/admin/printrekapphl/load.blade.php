...
<div id="id-elemen-yang-ingin-di-print"> 
						...
						<div style="text-align: center;font-weight: bold;font-size: 25px;">	REKAPITULASI HONORIUM (PHL)   </div>
					<div class="comnames">{{ $loggedAdmin->company->company_name }}</div>
...
$jumlah_nilai_tpp_total = 0;
?>

@foreach ($employeeAttendence as $key => $payrolls)
<?php
...
<td style="  padding: 10px;  text-align: left;vertical-align: middle;"><b>{{ $payrolls->full_name }}</td>	
 @if ($caricount =="0")	
<td colspan="7" style="background: #fbf7f7;text-align: center;">BELUM ADA REKAP PADA BULAN {{ $databulan }} TAHUN {{ $datatahun }}</td>	

@if($loggedAdmin->company->datashift==1)
@if ($payrolls->datashift ==1)	
...
<td style=" vertical-align: middle; ">{{ $payrolls->jumlah_prestasi_kehadiran }}</td>
<td style=" vertical-align: middle; ">{{ $payrolls->jumlah_prestasi_kinerja }}</td>
<td style=" vertical-align: middle; ">{{ $payrolls->total_prestasi_kinerja }}</td>

<td style=" vertical-align: middle; ">
<?php
$number2 = $payrolls->nilai_tpp_kinerja;
$jumlah_nilai_tpp_kinerja = number_format ($number2, 0, ',', '.');
$jumlah_nilai_tpp_total += $payrolls->nilai_tpp_kinerja;
?>

{{ $jumlah_nilai_tpp_kinerja }}
</td>	
...
@if($loggedAdmin->company->datashift==1)
@if ($payrolls->datashift ==1)	
<td style=" vertical-align: middle; "><div class="noprint"><a style="width:100%" href="shitkinerjas/{{ $payrolls->idpay }}/edit" class="btn btn-success btn-sm" >Edit</a></div></td>
@else
<td style=" vertical-align: middle; "><div class="noprint"><a style="width:100%" href="payrolls/{{ $payrolls->idpay }}/edit" class="btn btn-success btn-sm" >Edit</a></div></td>
...
<td colspan="11" style="  padding: 10px;  text-align: center;vertical-align: middle;"><b>JUMLAH KESELURUHAN TIDAK DI TEMUKAN</b></td>
</tr>	
@else
<tr style="background:green;font-size:15px;">
<td colspan="5" style="  padding: 10px; color: #fff; text-align: center;vertical-align: middle;"><b>JUMLAH KESELURUHAN</b></td>
<td style=" vertical-align: middle;font-weight:bold;color: #fff;  ">
<?php
$total1 = $jumlah_nilai_tpp_total;
$nilai_tpp_kinerja_rp = number_format ($total1, 0, ',', '.');

?>

{{ $nilai_tpp_kinerja_rp }}</td>
...
{{ $kepaladinas->full_name }}<div style="font-size:13px;">NIP: {{ $kepaladinas->employeeID }} </div>
@endif
@else  
....................................<div style="font-size:13px;">NIP....................................</div>	
@endif
...
@if($countbendahara == 1 ) 
@if($countbendaharanojab == 1 )	
	....................................<div style="font-size:13px;">NIP....................................</div>
@else 
{{ $bendahara->full_name }} <div style="font-size:13px;">NIP: {{ $bendahara->employeeID }}</div></td>
@endif
@else  
	....................................<div style="font-size:13px;">NIP....................................</div>	
@endif
