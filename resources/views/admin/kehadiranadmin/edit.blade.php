  ...
  @if(admin()->unikid =='0')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Tambah Kehadiran (ASN)</span>
            </li>
        </ul>
                ...
                <div class="portlet-body form">
                    ...
                    @else
                        <div class="table-toolbar margin-top-15">
                            <div class="row">
                                <div class="col-md-4">
                                    {!! Form::open(['route'=>["admin.kehadiranadmin.create"], 'method' => 'GET', 'class' => "form-inline", 'id' => "new_date"]) !!}
                                    <div class="btn-group">
                        ...
                        @else
                            {!! Form::open(['route' => ["admin.kehadiranadmin.update", $date->format("Y-m-d")], 'class'=>'form-horizontal ajax_form', 'method'=>'PATCH']) !!}
    ...
    <script>
        ...
        function loadDataTable() {
            table = $('#attendanceTable').dataTable({
                ...
                "bServerSide": true,
                "ajax": {
                    "url": "{{ URL::route("admin.kehadiranad.ajax_attendance") }}",
                    "data": function (d) {
...
//			 $('#halfDayLabel').show(100);
        ...
        $('#date_change').datepickerabsen({
            ...
            var url = "{{ route("admin.kehadiranadmin.edit", "#id") }}";
        ...
        function ajaxUpdateAttendance() {
            ...
            var url = "{{ route("admin.kehadiranadmin.update", "#id") }}";
            url = url.replace("#id", date);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var route = "{{ route("admin.kehadiranadmin.edit", "#id") }}";
        ...
        function attendanceRow(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{!! route('admin.kehadiranad.update.row') !!}",
                data: {
                    "id": id,
                    "status": status,
