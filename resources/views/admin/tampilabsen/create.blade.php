<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title"><strong><i
                        class="la la-plus"></i>Tambahkan Data Periode</strong></h4>
    </div>
    <div class="modal-body" style="padding-top: 0px;">
        <div class="panel-body form">
            ...
            <div class="modal-body">
				...
				<div class="form-group" style="background: #dfe8f3;padding: 5px;border-radius: 3px;">
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">DATA UTAMA</div>
                    ...
                    <input type="hidden" name="leaveformType" id="leaveformType" value="date_range">
                            ...
                            <input class="form-control" type="text" name="judul_nama" id="judul_nama" placeholder="Ketik Nama Absensi">
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Masuk Senin-Kamis</div>
                            ...
                            <div class="col-md-6">Mulai Jam Masuk <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text" name="jam_masuk"  id="jam_masuk"  >
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Tutup Absen Masuk  <span class="required">*  </span>
                            <input class="form-control " type="text" name="jam_akhir_masuk"  id="jam_akhir_masuk"  >
							<span class="help-block"></span>
                            </div>
...
$("#jam_akhir_masuk").inputmask({"mask": "99:99:99"});
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Masuk Juma'at</div>
                            ...
                            <div class="col-md-6">Mulai Jam Masuk <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text" name="jam_masuk_jumat"  id="jam_masuk_jumat"  >
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Tutup Absen Masuk  <span class="required">*  </span>
                            <input class="form-control " type="text" name="jam_akhir_masuk_jumat"  id="jam_akhir_masuk_jumat"  >
							<span class="help-block"></span>
                            </div>
...
$("#jam_akhir_masuk_jumat").inputmask({"mask": "99:99:99"});
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Pulang Senin-Kamis</div>
                            ...
                            <div class="col-md-6">Mulai Jam Pulang <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text" name="jam_pulang"  id="jam_pulang"  >
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Tutup Absen Pulang  <span class="required">*  </span>
                            <input class="form-control " type="text" name="jam_akhir_pulang"  id="jam_akhir_pulang"  >
							<span class="help-block"></span>
                            </div>
...
$("#jam_akhir_pulang").inputmask({"mask": "99:99:99"});
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">Jam Pulang Juma'at</div>
                            ...
                            <div class="col-md-6">Mulai Jam Pulang <span class="required">*  </span>
                             ...
                             <input class="form-control " type="text" name="jam_pulang_jumat"  id="jam_pulang_jumat"  >
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Tutup Absen Pulang  <span class="required">*  </span>
                            <input class="form-control " type="text" name="jam_akhir_pulang_jumat"  id="jam_akhir_pulang_jumat"  >
							<span class="help-block"></span>
                            </div>
...
$("#jam_akhir_pulang_jumat").inputmask({"mask": "99:99:99"});
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">{{ $data->dataSkor }} Senin s/d Kamis</div>
							...
							<input class="form-control" type="hidden" name="id_{{ $data->singkat }}"  id="id_{{ $data->singkat }}" value="{{ $data->num_of_leave }}">
                             <input class="form-control " type="text" name="{{ $data->singkat }}_masuk"  id="{{ $data->singkat }}_masuk"  >
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Jam Akhir Skors  <span class="required">*  </span>
                            <input class="form-control " type="text" name="{{ $data->singkat }}_pulang"  id="{{ $data->singkat }}_pulang"  >
							<span class="help-block"></span>
                            </div>
              ...
              <div style="font-size: 15px;font-weight: bold;padding-left: 15px;padding-bottom:5px">{{ $data->dataSkor }} Jumat</div>
                            ...
                            <div class="col-md-6">Jam Mulai Skors  <span class="required">*  </span>
							<input class="form-control" type="hidden" name="id_jumat_{{ $data->singkat }}"  id="id_jumat_{{ $data->singkat }}" value="{{ $data->num_of_leave }}" required>
                             <input class="form-control " type="text" name="{{ $data->singkat }}_masuk_jumat"  id="{{ $data->singkat }}_masuk_jumat"  required>
							 <span class="help-block"></span>
                            </div>
							
							<div class="col-md-6">Jam Akhir Skors  <span class="required">*  </span>
                            <input class="form-control " type="text" name="{{ $data->singkat }}_pulang_jumat"  id="{{ $data->singkat }}_pulang_jumat"  required>
							<span class="help-block"></span>
                            </div>
...
$("#{{ $data->singkat }}_masuk").inputmask({"mask": "99:99:99"});
            ...
            <div class="modal-footer">
                <div class="row">
                 ...
                 <button type="button" onclick="addUpdateLeaveType();return false;" class="btn blue">
                            <i class="fa fa-plus"></i> Lanjutkan Buat Periode</button>
