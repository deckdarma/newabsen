...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Edit Form Papan Pengumuman</span>
            </li>
        </ul>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="status">
                                    <option value="active"
                                            @if($notice->status=='active')selected @endif >Aktifkan</option>
                                    <option value="inactive"
                                            @if($notice->status=='inactive')selected @endif>Matikan</option>
                                </select>
