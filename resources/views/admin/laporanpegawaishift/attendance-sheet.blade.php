...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Laporan Pegawai Shift (ASN)</span>
            </li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive" id="laporpegawaishift-sheet">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('footerjs')
    ...
    <script type="text/javascript">
       ...
       var filter = () => {
            ...
            var url = "{{ route('admin.laporpegawaishift.filter') }}";
            $.easyAjax({
                type: 'POST',
                url: url,
                container: '#laporpegawaishift-sheet',
                data: data,
                success: function (res) {
                    if (res.status === 'success') {
                        $('#laporpegawaishift-sheet').html(res.data);
                    }
                }
            });
        };
