    ...
    <div class="page-head">
        ...
        <div class="page-toolbar">
            ...
            <div class="btn-theme-panel">
                <a onclick="loadView('{{ route('admin.laporpegawai.index') }}')" class="btn {{ isset($viewAttendanceActive) ? $viewAttendanceActive : ''}}">
                    <i class="fa fa-th"></i>
                </a>
                <a onclick="loadView('{{ route('admin.laporpegawai.employee') }}')" class="btn {{ isset($viewAttendanceEmployeeActive) ? $viewAttendanceEmployeeActive : ''}}">
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $('#sample_1').dataTable({
                ...
                {!! $datatabble_lang !!}
                "aaSorting": [[2, "asc"]],
                "ajax": "{{ route("admin.laporpegawai.ajax_employees") }}",
                "columns": [
