...
@include('admin.attendances.col4_periode_jumat')
@else
@include('admin.attendances.col4_periode')	
@endif
<!-- ELSE PERIODE --> @else
	@if ($tampilkanhari == "friday")
@include('admin.attendances.col4_normal_jumat')
@else
@include('admin.attendances.col4_normal')	
@endif	
