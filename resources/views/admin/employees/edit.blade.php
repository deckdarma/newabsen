                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="statusmupeg">
                                    ...
                                    <option value="ASN" @if($employee->statusmupeg=='ASN') selected @endif>ASN</option>
...
@foreach ($golonganpeg as $data)
		 ...
		 @else
		 <input type="hidden" name="golongan" class="form-control" value="{{ $employee->golongan }}">
		@endif 
...
@endif 
						<div class="form-group">
                            ...
                            <div class="col-md-9">
                                 ...
                                 <option value="1" @if($employee->shift=='1') selected @endif>YA</option>
                                    <option value="0" @if($employee->shift=='0') selected @endif>TIDAK
                                    </option>
		...
		<input type="hidden" name="annual_leave" class="form-control"  value="{{$employee->annual_leave}}">
