...
@endif
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Laporan Pegawai Non Shift (PHL)</span>
            </li>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive" id="laporphlnonshift-sheet">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('footerjs')
    ...
    <script type="text/javascript">
       ...
       var filter = () => {
            ...
            var url = "{{ route('admin.laporphlnonshift.filter') }}";
            $.easyAjax({
                type: 'POST',
                url: url,
                container: '#laporphlnonshift-sheet',
                data: data,
                success: function (res) {
                    if (res.status === 'success') {
                        $('#laporphlnonshift-sheet').html(res.data);
                    }
                }
            });
        };
