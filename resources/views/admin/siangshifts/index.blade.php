...
@section('mainarea')
    ...
    <div class="page-head">
        <div class="page-title"><h1>
                @lang("pages.siangshifts.indexTitle")
            </h1></div>
        <div class="page-toolbar">
            <!-- BEGIN THEME PANEL -->
            <div class="btn-theme-panel">
                <a onclick="loadView('{{ route('admin.siangshifts.index') }}')" class="btn {{ isset($viewDatashiftActive) ? $viewDatashiftActive : ''}}">
                    <i class="fa fa-th"></i>
                </a>
                <a onclick="loadView('{{ route('admin.siangshift.employee') }}')" class="btn {{ isset($viewDatashiftEmployeeActive) ? $viewDatashiftEmployeeActive : ''}}">
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">@lang("pages.siangshifts.indexTitle")</span>
            </li>
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    ...
                    <div class="table-toolbar margin-top-15">
                        <div class="row">
                            <div class="col-md-4">
                                {!! Form::open(['route'=>["admin.siangshifts.create"], 'method'=>'GET', 'class' => "form-inline"]) !!}
                                <div class="btn-group">
                            ...
                            <div class="col-md-4">
                                <div class="btn-group pull-right">
                                    <a href="{{route('admin.siangshifts.create')}}"
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $('#sample_1').dataTable({
                ...
                {!! $datatabble_lang !!}
                "aaSorting": [[2, "asc"]],
                "ajax": "{{ route("admin.siangshift.ajax_employees") }}",
                "columns": [
