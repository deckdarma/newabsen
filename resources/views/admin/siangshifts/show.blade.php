...
<div class="page-head">
    <div class="page-title">
        <h1>
            @lang("pages.siangshifts.indexTitle") - {{ $employee->full_name }}
        </h1>
    </div>
</div>
<div class="page-bar">
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a onclick="loadView('{{ route('admin.siangshifts.index') }}')" >@lang("pages.siangshifts.indexTitle")</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span class="active">@lang("pages.siangshifts.editTitle")</span>
        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="alert alert-danger text-center">
                                            <strong>{{trans('core.siangshift')}}</strong>
                                            <div id="siangshiftReport">-</div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="alert alert-danger text-center">
                                            ...
                                            <div id="siangshiftPerReport">-</div>
                                        </div>
                                    </div>
                                    <!--/span-->
...
<script>
    ...
    function showReport() {
        ...
        var url = "{{ route('admin.siangshift.report',':id') }}";
        ...
        $.ajax({
            ...
            if (response.success == "success") {
                ...
                $('#siangshiftReport').html(response.presentByWorking);
                $('#siangshiftPerReport').html(response.siangshiftPerReport);
    ...
    function redirect_to() {
        ...
        var url = "{{ route('admin.siangshifts.show',':id') }}";
            ...
            initCalendar: function () {
                ...
                $('#calendar').fullCalendar({ //re-initialize the calendar
                    ...
                    events: [
                        ...
                        {{-- Datashift on calendar --}}

                            @foreach($datashift as $attend)
                            {
                                title: "{{$attend->status}}",
                                start: '{{$attend->date}}',
