...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a onclick="loadView('{{ route('admin.leave_applications.index') }}')">Data Keterangan</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
...
{!! HTML::script('front_assets/plugins/scrollbar/src/perfect-scrollbar.js') !!}
  ...
  @if($loggedAdmin->company->perjalanan =='active')
  ...
  <script id="rendered-js" >
        ...
        $('#start_date').datepicker({
            ...
            minDate: -{{ $loggedAdmin->company->waktumundur}},
