            ...
            <div class="modal-body">
			 ...
			 <input style="background-color: #fcf0f0;border: 1px solid #c19696;" class="form-control"  id="employee_id" name="employee_id" type="hidden" value="{{ $leavetype->employee_id}}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                             <input class="form-control" style="    background-color: #fcf0f0;border: 1px solid #c19696;"  value="{{ $leavetype->start_date}}" type="text"    id="datedis"
                                           placeholder="Tanggal Mulai" readonly>
										   
										      <input class="form-control" style="    background-color: #fcf0f0;border: 1px solid #c19696;"  value="{{ $leavetype->start_date}}" type="hidden"  name="start_date"  id="start_date" readonly>
