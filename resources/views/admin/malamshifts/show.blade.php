...
<div class="page-head">
    <div class="page-title">
        <h1>
            @lang("pages.malamshifts.indexTitle") - {{ $employee->full_name }}
        </h1>
    </div>
</div>
<div class="page-bar">
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <a onclick="loadView('{{ route('admin.malamshifts.index') }}')" >@lang("pages.malamshifts.indexTitle")</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span class="active">@lang("pages.malamshifts.editTitle")</span>
        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="alert alert-danger text-center">
                                            <strong>{{trans('core.malamshift')}}</strong>
                                            <div id="malamshiftReport">-</div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    ...
                                    <div class="col-md-6">
                                        <div class="alert alert-danger text-center">
                                            ...
                                            <div id="malamshiftPerReport">-</div>
                                        </div>
                                    </div>
                                    <!--/span-->
...
<script>
    ...
    function showReport() {
        ...
        var url = "{{ route('admin.malamshift.report',':id') }}";
        ...
        $.ajax({
            ...
            if (response.success == "success") {
                ...
                $('#malamshiftReport').html(response.presentByWorking);
                $('#malamshiftPerReport').html(response.malamshiftPerReport);
    ...
    function redirect_to() {
        ...
        var url = "{{ route('admin.malamshifts.show',':id') }}";
