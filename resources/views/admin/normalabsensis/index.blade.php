...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Pengaturan Absensi Normal</span>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="Normalabsensi">
                        <thead>
                        <tr>
...
@section('footerjs')
    ...
    <script>
        ...
        var table = $('#Normalabsensi').dataTable({
            "cache": true,
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "order": [[1, "asc"]],
            "ajax": "{{ URL::route("admin.normalabsensis.ajax_list") }}",
            "aoColumns": [
        ...
        function del(id, name) {
            ...
            $('#deleteModal').find("#delete").off().click(function () {
                ...
                var url = "{{ route('admin.normalabsensis.destroy',':id') }}";
        ...
        function showEdit(id) {
            var url = "{{ route('admin.normalabsensis.edit',':id') }}";
            url = url.replace(':id', id);
        ...
        function showAdd() {
            var url = "{{ route('admin.normalabsensis.create') }}";
            $.ajaxModal('#showModal', url);

        }

        function addUpdateNormalAbsensi(id) {

            if (typeof id != 'undefined') {
                var url = "{{ route('admin.normalabsensis.update',':id') }}";
                url = url.replace(':id', id);
            } else {
                url = "{{route('admin.normalabsensis.store')}}";
            }
            $.easyAjax({
                type: 'POST',
                url: url,
